...
/**
 * Implementation of the {@link UserService} which accesses the {@link UserDetails}
...
public class UserServiceImpl implements UserService {
    ...
    public User save(User user) {
        ...
        LOG.info("User:" + justSavedUser.getFirstName() + " saved.");
...
//    }
    ...
    @Override
    public User findByEmailAndTenantname(String email, String tenant) { 
        User user = userRepository.findByEmailAndTenantname(email,
                tenant);
        LOG.info("Found user with username:" + user.getFirstName()
                + " from tenant:" + user.getTenant());
        return user;
    }
